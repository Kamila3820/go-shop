...
import (
	...
	"github.com/Kamila3820/go-shop-tutorial/modules/users/usersPatterns"
...
type IUsersRepository interface {
	...
	UpadateOauth(req *users.UserToken) error
...
func (r *usersRepository) UpadateOauth(req *users.UserToken) error {
	query := `
	UPDATE "oauth" SET
